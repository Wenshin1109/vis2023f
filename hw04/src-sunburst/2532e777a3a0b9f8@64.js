...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作地點位於北部的超過半數</li>
    <li>對於國內所有地區藝術工作者而言，減少包裝材及文宣印製/使用無毒媒材、再生材料、廢物利用素材等/工作場所、活動展場的節約能源，此三種行動皆是前三名</li>
    <li>而對東部而言使用無毒媒材、再生材料、廢物利用素材等較減少包裝材及文宣印製稍多一些</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["北部", "南部", "美術館", "減少包裝材及文宣印製", "使用無毒媒材、再生材料、廢物利用素材等", "工作場所、活動展場的節約能源"])
